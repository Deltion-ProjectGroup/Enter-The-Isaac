...
public class RippleEffect : MonoBehaviour
{
    ...
    public void Emit()
    {
       // droplets[dropCount++ % droplets.Length].Reset(new Vector2(Random.value, Random.value));
       droplets[dropCount++ % droplets.Length].Reset(new Vector2(0.5f,0.5f));
    }
