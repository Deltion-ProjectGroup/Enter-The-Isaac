...
public class BulletMove : MonoBehaviour
{
    ...
    {
        RaycastHit hit;
        if (Physics.SphereCast(lastPos, 0.1f, -(lastPos - transform.position), out hit, Vector3.Distance(transform.position, lastPos),~LayerMask.GetMask("Ignore Raycast","Bullet","EnemyBullet","RoomHolder","TriggerInteractables")))
        {
